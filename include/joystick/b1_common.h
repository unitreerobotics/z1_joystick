...
#pragma pack(1)
	...
	/**
	 * @brief Describes the IMU data
	 * 
	 * @attention when under accelerated motion, the attitude of the robot calculated by IMU will drift.
	 */
	typedef struct
	{
	...
	/**
	 * @brief Describes the unitree motor state
	 */
	typedef struct
	{
	...
	/**
	 * @brief Describes the unitree motor command
	 */
	typedef struct
	{
	...
	/**
	 * @brief Describes the low level state feedback
	 */
	typedef struct
	{
	...
	/**
	 * @brief Describes the low level command
	 */
	typedef struct
	{
		std::array<uint8_t, 2> head;
	...
	/**
	 * @brief Describes the high level state feedback
	 */
	typedef struct
	{
		std::array<uint8_t, 2> head;
	...
	/**
	 * @brief Describes the high level command
	 */
	typedef struct
	{
		std::array<uint8_t, 2> head;
